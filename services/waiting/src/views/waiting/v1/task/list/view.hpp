...
class WaitingV1TaskListPost final : public views::contract::BaseHandler< ::waiting::handlers::ListTasksRequest> {
public:
    static constexpr std::string_view kName = "waiting-v1-task-list-post";

    WaitingV1TaskListPost(
...
protected:
    views::contract::models::ApiResponse Handle(
        ::waiting::handlers::ListTasksRequest&& request,
