...
class WaitingV1TaskCompletePost final : public views::contract::BaseHandler< ::waiting::handlers::TaskIdRequest> {
public:
    static constexpr std::string_view kName = "waiting-v1-task-complete-post";

    WaitingV1TaskCompletePost(
