...
#include "waiting/sql_queries.hpp"

namespace waiting::providers::tasks_provider {
...
TasksProvider::TasksProvider(
    ...
    : userver::components::ComponentBase(config, component_context),
      pg_cluster_(component_context.FindComponent<userver::components::Postgres>("postgres-waiting").GetCluster()) {}
