...
void CurrentActionsClient::MoveTask(::waiting::handlers::Task&& task) const {
    ::waiting::handlers::MoveTaskRequest request_body;
    request_body.task = task;

    PerformRequest<void, ::waiting::handlers::MoveTaskRequest>(
