...
class SometimeLaterV1TaskPost final
    : public views::contract::BaseHandler< ::sometime_later::handlers::CreateTaskRequest> {
public:
    static constexpr std::string_view kName = "sometime-later-v1-task-post";

    SometimeLaterV1TaskPost(
...
protected:
    views::contract::models::ApiResponse Handle(
        ::sometime_later::handlers::CreateTaskRequest&& request,
