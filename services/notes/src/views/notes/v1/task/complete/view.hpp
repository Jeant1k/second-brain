...
class NotesV1NoteCompletePost final : public views::contract::BaseHandler< ::notes::handlers::NoteIdRequest> {
public:
    static constexpr std::string_view kName = "notes-v1-note-complete-post";

    NotesV1NoteCompletePost(
