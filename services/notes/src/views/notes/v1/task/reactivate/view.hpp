...
class NotesV1TaskReactivatePost final : public views::contract::BaseHandler< ::notes::handlers::TaskIdRequest> {
public:
    static constexpr std::string_view kName = "notes-v1-task-reactivate-post";

    NotesV1TaskReactivatePost(
