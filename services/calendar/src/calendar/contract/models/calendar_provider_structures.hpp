...
namespace calendar::contract::models {
...
template <>
struct CppToUserPg<calendar::contract::models::Status> : EnumMappingBase<calendar::contract::models::Status> {
    static constexpr DBTypeName postgres_name = "calendar.note_status";
