...
from .plugins.utils import select_tasks_and_tags
...
async def test_create_task(
    ...
    assert select_tasks_and_tags(pgsql, initial_data['request_body'].get('user_id', 0)) == expected_data['tasks_and_tags']
