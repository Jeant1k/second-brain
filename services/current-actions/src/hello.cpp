 ...
 public:
  ...
  Hello(const userver::components::ComponentConfig& config,
      ...
      : HttpHandlerBase(config, component_context),
        pg_cluster_(
            component_context
                .FindComponent<userver::components::Postgres>("postgres-current-actions")
                .GetCluster()) {}
  ...
  std::string HandleRequestThrow(
    ...
    return current_actions::SayHelloTo(name, user_type);
  }
...
void AppendHello(userver::components::ComponentList& component_list) {
  ...
  component_list.Append<userver::components::Postgres>("postgres-current-actions");
